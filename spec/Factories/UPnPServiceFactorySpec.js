...
describe("UPnPServiceFactory", function () {
	...
	beforeEach(function () {
		...
		_sut = new UPnPServiceFactory(_mockXmlParser, _mockUrlProvider, _mockUPnPExtensionInfoFactory, _mockServiceProperyFactory, _mockServiceMethodFactory, _mockServiceExecutor, _mockExecutableServiceMethodFactory);
	});
