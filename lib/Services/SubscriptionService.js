...
class SubscriptionService {
	...
	subscribe(directResponsesTo, subscriptionUrl, subscriptionId, timeout) {
		if (!directResponsesTo) return Promise.reject("Argument null exception.  Argument 'directResponsesTo' cannot be null.");
		if (!subscriptionUrl) return Promise.reject("Argument null exception.  Argument 'subscriptionUrl' cannot be null.");
		if (!timeout) return Promise.reject("Argument null exception.  Argument 'timeout' cannot be null.");
	...
	unsubscribe(subscriptionUrl, subscriptionId) {
		if (!subscriptionUrl) return Promise.reject("Argument null exception.  Argument 'subscriptionUrl' cannot be null.");
		if (!subscriptionId) return Promise.reject("Argument null exception.  Argument 'subscriptionId' cannot be null.");
